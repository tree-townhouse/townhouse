...
export interface Locale extends ILocale {
     ...
     * サイレンスの理由を入力してください。
     */
    "silenceReasonDescription": string;
    /**
     * 現在サイレンス状態です。公開範囲がホームに制限されています。
     */
    "silencedNotice": string;
    /**
     * {date}までサイレンス
     */
    "silencedUntil": ParameterizedString<"date">;
    /**
     * サイレンスお知らせテンプレート
     */
    "silenceAnnouncementTemplate": string;
    /**
     * お知らせタイトル
     */
    "silenceAnnouncementTitleLabel": string;
    /**
     * お知らせ内容
     */
...
<<<<<<< HEAD
     ...
     * 制限を解除しますか？
     */
    "unrestrictConfirm": string;
    /**
     * 制限期間
     */
    "restrictPeriod": string;
    /**
     * 制限の理由
     */
     ...
     * 制限の理由を入力してください。
     */
    "restrictReasonDescription": string;
    /**
     * 現在制限状態です。読み取り専用に制限されています。
     */
     ...
     * {date}まで制限
     */
    "restrictedUntil": ParameterizedString<"date">;
    /**
     * 制限お知らせテンプレート
     */
    "restrictAnnouncementTemplate": string;
    /**
     * お知らせタイトル
     */
    "restrictAnnouncementTitleLabel": string;
    /**
     * お知らせ内容
     */
    "restrictAnnouncementTextLabel": string;
    /**
     * {reason}は理由、{message}は管理者メッセージ、{period}は期間、{date}は日時、{enddate}は終了日時に置き換えられます。
     */
...
>>>>>>> cac68b24eba6bd5fc275f48f551c730958301332
     ...
     * 警告の理由を入力してください。
     */
    "warnReasonDescription": string;
    /**
     * 警告{count}回
     */
    "warningCount": ParameterizedString<"count">;
    /**
     * 警告リセット
     */
    "resetWarning": string;
    /**
     * このユーザーの警告回数をリセットしますか？
     */
    "resetWarningConfirm": string;
    /**
     * 警告お知らせテンプレート
     */
    "warningAnnouncementTemplate": string;
    /**
     * お知らせタイトル
     */
    "warningAnnouncementTitleLabel": string;
    /**
     * お知らせ内容
     */
...
>>>>>>> cac68b24eba6bd5fc275f48f551c730958301332
     ...
     * 凍結お知らせテンプレート
     */
    "suspendAnnouncementTemplate": string;
    /**
     * お知らせタイトル
     */
    "suspendAnnouncementTitleLabel": string;
    /**
     * お知らせ内容
     */
...
<<<<<<< HEAD
    ...
    "adminMessage": string;
    /**
     * 制裁通知テンプレートの{message}の位置に表示されます。
     */
...
>>>>>>> cac68b24eba6bd5fc275f48f551c730958301332
     ...
     * 履歴を削除
     */
    "deleteModerationLog": string;
    /**
     * この履歴を完全に削除しますか？ユーザーの制裁履歴からも消えます。
     */
    "confirmDeleteModerationLog": string;
    /**
     * 変更日時
     */
     ...
     * 履歴のみ削除
     */
    "deleteLogOnly": string;
    /**
     * モデレーション履歴はありません。
     */
    "noModerationHistory": string;
    /**
     * 変更なし
     */
    "noChange": string;
    ...
    /**
     * このチャンネルは運営の承認を待っています。
     */
    "thisChannelPendingApproval": string;
    /**
     * チャンネル作成が申請されました。運営の承認後にチャンネルが有効になります。
     */
    "channelCreationRequestSent": string;
    /**
     * チャンネル作成申請のキャンセル
     */
    "cancelChannelCreation": string;
    /**
     * チャンネル作成申請をキャンセルしますか？チャンネルは削除されます。
     */
    "cancelChannelCreationConfirm": string;
    /**
     * このチャンネルからBANされています。
     */
    "youAreBannedFromThisChannel": string;
    /**
     * このチャンネルのモデレーターです。
     */
    "youAreModerator": string;
    /**
     * チャンネル設定
     */
    ...
    /**
     * このユーザーのモデレーター権限を解除しますか？
     */
    "removeModeratorConfirm": string;
    /**
     * モデレーターはいません。
     */
    "noModerators": string;
    /**
     * モデレーター招待を送信しました。該当ユーザーが承諾するとモデレーターに任命されます。
     */
    "moderatorInvitationSent": string;
    /**
     * このユーザーをモデレーターとして招待しますか？
     */
    "inviteModeratorConfirm": string;
    /**
     * モデレーターを解除しました。
     */
    ...
    "banPermanent": string;
    /**
     * サーバー運営やチャンネル管理者をBANすることはできません。
     */
    "banErrorCannotBanAdmin": string;
    /**
     * 既にBANされているユーザーです。
     */
    "banErrorAlreadyBanned": string;
    /**
     * 期限切れ
     */
    "banExpired": string;
     ...
     * 残り{days}日
     */
    "banRemainingDays": ParameterizedString<"days">;
    /**
     * 残り{hours}時間
     */
    "banRemainingHours": ParameterizedString<"hours">;
    /**
     * このユーザーのBANを解除しますか？
     */
    "unbanUserConfirm": string;
    /**
     * このチャンネルからBAN
     */
    "channelBanUser": string;
    /**
     * チャンネル管理者
     */
    "channelOwner": string;
     ...
     * チャンネル作成に承認が必要
     */
    "requireChannelApproval": string;
    /**
     * 有効にすると、新しいチャンネルの作成にサーバー管理者の承認が必要になります。
     */
    "requireChannelApprovalDescription": string;
    /**
     * チャンネル管理
     */
     ...
     * 承認待ちのチャンネルはありません。
     */
    "noPendingChannels": string;
    /**
     * '{name}'チャンネルを承認しますか？
     */
    "approveChannelConfirm": ParameterizedString<"name">;
    /**
     * '{name}'チャンネルを削除しますか？チャンネル内のすべてのノートも一緒に削除されます。
     */
    "deleteChannelConfirm": ParameterizedString<"name">;
    /**
     * 管理者の変更
     */
    "transferOwnership": string;
    /**
     * '{name}'チャンネルの管理者を@{user}に変更しますか？
     */
    "transferOwnershipConfirm": ParameterizedString<"name" | "user">;
    /**
     * '{name}'チャンネルのモデレーター
     */
    "channelModeratorsOf": ParameterizedString<"name">;
    /**
     * 管理記録
     */
    "channelModerationLog": string;
    /**
     * 管理記録はありません。
     */
     ...
     * モデレーターを任命しました
     */
    "logAddModerator": string;
    /**
     * モデレーターを解任しました
     */
    "logRemoveModerator": string;
    /**
     * ユーザーをBANしました
     */
    "logBanUser": string;
     ...
     * チャンネル名は変更できません。
     */
    "cannotChangeChannelName": string;
    /**
     * ノートの表示
     */
    ...
    "_announcement": {
        ...
        /**
         * 指定した日時に自動的にお知らせが公開されます。
         */
        "scheduledPublishDescription": string;
        /**
         * 予約アーカイブ
         */
        "scheduledArchive": string;
        /**
         * 指定した日時に自動的にお知らせがアーカイブされます。
         */
        "scheduledArchiveDescription": string;
        /**
         * 予約済み
         */
        "scheduled": string;
    ...
    "_channel": {
         ...
         * {n}人がフォロー中
         */
        "followersCount": ParameterizedString<"n">;
        /**
         * {n}投稿があります
         */
    ...
    "_permissions": {
         ...
         * ユーザーに警告する
         */
        "write:admin:warn-user": string;
        /**
         * ユーザーの警告をリセット
         */
        "write:admin:reset-user-warning": string;
        /**
         * 制裁履歴を取り消す
         */
    ...
    "_notification": {
         ...
         * チャンネルモデレーターに招待されました！
         */
        "channelModeratorInvitationReceived": string;
        /**
         * チャンネルモデレーターの招待が承諾されました！
         */
        "channelModeratorInvitationAccepted": string;
        /**
         * チャンネル作成申請が承認されました！
         */
        "channelApproved": string;
        "_types": {
            /**
             * すべて
             */
