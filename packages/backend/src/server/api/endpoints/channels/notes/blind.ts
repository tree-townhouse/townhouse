...
export const meta = {
	...
	errors: {
		accessDenied: {
			...
			code: 'ACCESS_DENIED',
			id: 'e0460b5e-1a02-4c29-a8b0-003002000001',
		},
		noSuchNote: {
			message: 'No such note.',
			code: 'NO_SUCH_NOTE',
			id: 'e0460b5e-1a02-4c29-a8b0-003002000002',
		},
	},
} as const;
...
export const paramDef = {
	...
	required: ['channelId', 'noteId', 'isBlinded'],
} as const;
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			try {
				await this.channelModerationService.blindNote(ps.channelId, me.id, ps.noteId, ps.isBlinded);
			} catch (e: any) {
				switch (e.message) {
