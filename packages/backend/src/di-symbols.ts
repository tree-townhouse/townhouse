...
export const DI = {
	...
	channelModeratorsRepository: Symbol('channelModeratorsRepository'),
	channelBansRepository: Symbol('channelBansRepository'),
	channelModerationLogsRepository: Symbol('channelModerationLogsRepository'),
